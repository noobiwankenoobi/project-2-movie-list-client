...
/***/ (function(module, exports, __webpack_require__) {
	...
	var moviePostEvents = __webpack_require__(13);
	var moviesEvents = __webpack_require__(42);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://project-2-movie-list-ross.herokuapp.com/',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var userAuthUi = __webpack_require__(12);
	// const showCreateMoviePostFields = require('../templates/createMoviePostFields.handlebars')

	// Needs finishing
	var onNewMoviePost = function onNewMoviePost(event) {
	  console.log(event.target);
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (data.movie_post.comment.trim()) {
	    api.newMoviePost(data).then(ui.newMoviePostSuccess).catch(ui.newMoviePostFailure);
	  } else {
	    userAuthUi.userMessage('You Must Enter a Comment');
	  }
	};

	var onGetMoviePosts = function onGetMoviePosts(event) {
	  event.preventDefault();
	  api.getMoviePosts().then(ui.getMoviePostsSuccess).catch(ui.getMoviePostsFailure);
	};
	...
	module.exports = {
	  addHandlers: addHandlers,
	  onNewMoviePost: onNewMoviePost,
	  onGetMoviePosts: onGetMoviePosts
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var newMoviePost = function newMoviePost(data) {
	  return $.ajax({
	    method: 'POST',
	...
	var getMoviePosts = function getMoviePosts() {
	  return $.ajax({
	    method: 'GET',
	    url: config.apiOrigin + '/movie_posts/',
	    headers: {
	...
	var deleteMoviePost = function deleteMoviePost(moviePostId) {
	...
	var updateMoviePost = function updateMoviePost(data) {
	  return $.ajax({
	    method: 'PATCH',
	...
	module.exports = {
	  newMoviePost: newMoviePost,
	  getMoviePosts: getMoviePosts,
	  deleteMoviePost: deleteMoviePost,
	  updateMoviePost: updateMoviePost
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var showMoviePostsTemplate = __webpack_require__(16);
	var api = __webpack_require__(14);
	var getFormFields = __webpack_require__(9);
	var userAuthUi = __webpack_require__(12);
	var moviesUi = __webpack_require__(36);

	// [GET ALL] MOVIES
	// [GET ALL] MOVIES

	var getMoviePostsSuccess = function getMoviePostsSuccess(data) {
	  userAuthUi.userMessage('Found Some Movie Posts!');
	  store.moviePosts = data.movie_posts;
	  refreshMoviePostsTable();
	};

	var getMoviePostsSuccessQuiet = function getMoviePostsSuccessQuiet(data) {
	  store.moviePosts = data.movie_posts;
	  refreshMoviePostsTable();
	};

	var getMoviePostsFailure = function getMoviePostsFailure(error) {
	...
	var refreshMoviePostsData = function refreshMoviePostsData() {
	  api.getMoviePosts().then(getMoviePostsSuccessQuiet).catch(getMoviePostsFailure);
	};

	var clearUpdateInputFields = function clearUpdateInputFields() {
	...
	var updateMoviePostSuccess = function updateMoviePostSuccess() {
	...
	var updateMoviePostFailure = function updateMoviePostFailure(error) {
	  userAuthUi.userMessage('Failed to Update Movie Post!');
	  console.error(error);
	};

	var updateMoviePost = function updateMoviePost(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  refreshMoviePostsTable();
	  if (data.movie_post.comment.trim()) {
	    api.updateMoviePost(data).then(updateMoviePostSuccess).catch(updateMoviePostFailure);
	  } else {
	    userAuthUi.userMessage('You Must Enter a Comment');
	  }
	};

	var showUpdateFields = function showUpdateFields(event) {
	  event.preventDefault();
	  var currentPostId = $(event.target).attr('data-id');
	  $('#update-post-input-id').val(currentPostId);
	  var currentPostArray = store.moviePosts.filter(function (moviePost) {
	    return String(moviePost.id) === currentPostId;
	  });
	  var currentPost = currentPostArray[0];
	  ...
	  $('#cancel-update-submit-button').on('click', function () {
	    $('.update-field').hide();
	  });
	};
	...
	var refreshMoviePostsTable = function refreshMoviePostsTable() {
	  var showMoviePostsHtml = showMoviePostsTemplate({ moviePosts: store.moviePosts });
	  $('#content').empty();
	...
	// [DELETE] MOVIE POST | [DELETE] MOVIE POST | [DELETE] MOVIE POST
	var deleteMoviePostSuccess = function deleteMoviePostSuccess() {
	  userAuthUi.userMessage('Movie Post Deleted!');
	  refreshMoviePostsData();
	};

	var deleteMoviePostFailure = function deleteMoviePostFailure(error) {
	  userAuthUi.userMessage('Failed to Delete Movie Post!');
	  console.error(error);
	};

	var deleteMoviePost = function deleteMoviePost(event) {
	  event.preventDefault();
	  var moviePostId = $(event.target).attr('data-id');
	  store.moviePosts = store.moviePosts.filter(function (moviePost) {
	    return String(moviePost.id) !== String(moviePostId);
	  });
	  refreshMoviePostsTable();
	  api.deleteMoviePost(moviePostId).then(deleteMoviePostSuccess).catch(deleteMoviePostFailure);
	};

	// [CREATE] NEW MOVIE POST
	// [CREATE] NEW MOVIE POST

	var newMoviePostSuccess = function newMoviePostSuccess(data) {
	  moviesUi.renderMoviePage(String(data.movie_post.movie_id));
	  userAuthUi.userMessage('Added New Movie Post!');
	};

	var newMoviePostFailure = function newMoviePostFailure(error) {
	  userAuthUi.userMessage('Failed to add New Movie Post!');
	  console.error(error);
	};

	module.exports = {
	  newMoviePostSuccess: newMoviePostSuccess,
	  newMoviePostFailure: newMoviePostFailure,
	  getMoviePostsSuccess: getMoviePostsSuccess,
	  getMoviePostsFailure: getMoviePostsFailure,
	  updateMoviePost: updateMoviePost
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr>\n        <td>"
	    ...
	    + "</td>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.parent_movie_post_id : stack1), depth0))
	    + "</td>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.comment : stack1), depth0))
	    + "</td>\n        <td>\n          <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-warning edit-movie-post-button\">Edit</button>\n          <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-danger delete-movie-post\">Delete</button>\n        </td>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<table id=\"movie-posts-table\" class=\"table table-striped signed-in-view\">\n\n  <thead>\n    <tr>\n      <th>#</th>\n      <th>Movie Id</th>\n      <th>User Id</th>\n      <th>Parent Movie Post Id</th>\n      <th>Comment</th>\n      <th>Management</th>\n    </tr>\n  </thead>\n\n  <tbody id=\"movie-posts-table-body\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.moviePosts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </tbody>\n\n</table>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var moviePostsApi = __webpack_require__(14);
	var getFormFields = __webpack_require__(9);
	var userAuthUi = __webpack_require__(12);
	var moviesPage = __webpack_require__(38);
	var moviePageView = __webpack_require__(39);
	var createMovieFieldsView = __webpack_require__(40);
	var editMovieFieldsView = __webpack_require__(41);
	...
	// [CREATE] NEW MOVIE | [CREATE] NEW MOVIE | [CREATE] NEW MOVIE | [CREATE] NEW MOVIE |
	// [CREATE] NEW MOVIE | [CREATE] NEW MOVIE | [CREATE] NEW MOVIE | [CREATE] NEW MOVIE |
	var newMovieSuccess = function newMovieSuccess() {
	...
	var newMovieFailure = function newMovieFailure(error) {
	...
	var onNewMovie = function onNewMovie(event) {
	  ...
	  api.newMovie(data).then(newMovieSuccess).catch(newMovieFailure);
	  // } else {
	  //   userAuthUi.userMessage('You Must Enter a Title')
	  // }
	};

	var onShowCreateMovieFields = function onShowCreateMovieFields(event) {
	  event.preventDefault();
	  var createMovieFieldsHTML = createMovieFieldsView();
	  $('#content').empty();
	...
	// [REFRESH MOVIES DATA] |
	var refreshMoviesData = function refreshMoviesData() {
	  api.getMovies().then(getMoviesSuccessQuiet).catch(getMoviesFailure);
	};

	// [REFRESH ALL MOVIES] | [REFRESH ALL MOVIES] | [REFRESH ALL MOVIES] | [REFRESH ALL MOVIES] |
	var refreshAllMovies = function refreshAllMovies() {
	  var allMoviesHTML = moviesPage({ movies: store.movies });
	  $('#content').empty();
	...
	var refreshUserMovies = function refreshUserMovies() {
	  var userMoviesHTML = moviesPage({ movies: store.userMovies });
	  $('#content').empty();
	...
	// }
	var cancelCreateMovie = function cancelCreateMovie() {
	  clearCreateInputFields();
	  $('#content').empty();
	};

	var cancelUpdateMovie = function cancelUpdateMovie() {
	  var currentMovieId = String($('#edit-movie-id-input').val());
	  clearEditInputFields();
	  $('#content').empty();
	  renderMoviePage(currentMovieId);
	};

	var onOpenEditMovieFields = function onOpenEditMovieFields() {
	  event.preventDefault();
	  var editMovieFieldsHTML = editMovieFieldsView();
	  $('#content').empty();
	  $('#content').append(editMovieFieldsHTML);
	  $('.hide-movie-id').hide();
	  // $('#edit-movie-modal').modal('show')
	  var currentMovieId = $(event.target).attr('data-id');
	  $('#edit-movie-id-input').val(currentMovieId);
	  var currentMovieArray = store.movies.filter(function (movie) {
	    return String(movie.id) === currentMovieId;
	  });
	  var currentMovie = currentMovieArray[0];
	...
	var clearCreateInputFields = function clearCreateInputFields() {
	...
	var clearEditInputFields = function clearEditInputFields() {
	...
	var getMoviesSuccessQuiet = function getMoviesSuccessQuiet(data) {
	  store.movies = data.movies;
	  refreshAllMovies();
	};

	var getMoviesFailure = function getMoviesFailure(error) {
	...
	// [GET (USER)] MOVIES | [GET (USER)] MOVIES | [GET (USER)] MOVIES | [GET (USER)] MOVIES | [GET (USER)] MOVIES | [GET (USER)] MOVIES |
	// [GET (USER)] MOVIES | [GET (USER)] MOVIES | [GET (USER)] MOVIES | [GET (USER)] MOVIES | [GET (USER)] MOVIES | [GET (USER)] MOVIES |
	var getUserMoviesSuccess = function getUserMoviesSuccess(data) {
	  userAuthUi.userMessage('Found Your Movies!');
	  store.movies = data.movies;
	  store.userMovies = data.movies.filter(function (movie) {
	    return store.user.id === movie.user_id;
	  });
	  refreshUserMovies();
	};

	var getUserMoviesFailure = function getUserMoviesFailure(error) {
	...
	var updateMovieSuccess = function updateMovieSuccess(data) {
	  ...
	  api.getMovies().then(function (moviesData) {
	...
	var updateMovieFailure = function updateMovieFailure(error) {
	...
	var onUpdateMovie = function onUpdateMovie(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateMovie(data).then(updateMovieSuccess).catch(updateMovieFailure);
	};
	...
	var onDeleteMovie = function onDeleteMovie(event) {
	  ...
	  store.movies = store.movies.filter(function (movie) {
	...
	// GET [MOVIE POSTS] (COMMENTS) RESPONSES | GET [MOVIE POSTS] (COMMENTS) RESPONSES
	var getMoviePostsSuccess = function getMoviePostsSuccess() {};
	...
	var onDeleteMoviePost = function onDeleteMoviePost(event) {
	  event.preventDefault();
	  var moviePostId = $(event.target).attr('data-id');
	  var currentMoviePosts = store.moviePosts.filter(function (moviePost) {
	    return moviePostId === String(moviePost.id);
	  });
	  var currentMoviePost = currentMoviePosts[0];
	  var movieId = currentMoviePost.movie_id;
	  moviePostsApi.deleteMoviePost(moviePostId).then(function () {
	    userAuthUi.userMessage('Movie Post Deleted!');
	    moviePostsApi.getMoviePosts().then(function (data) {
	      store.moviePosts = data.movie_posts;
	...
	var createMoviePost = function createMoviePost(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if (data.movie_post.comment.trim()) {
	    moviePostsApi.newMoviePost(data).then(newMoviePostSuccess).catch(newMoviePostFailure);
	  } else {
	    userAuthUi.userMessage('You Must Enter a Comment');
	  }
	};
	...
	//
	var showMoviePage = function showMoviePage(event) {
	  event.preventDefault();
	  var currentMovieId = $(event.target).attr('data-id');
	  renderMoviePage(currentMovieId);
	};

	var renderMoviePage = function renderMoviePage(currentMovieId) {
	  var currentMovieArray = store.movies.filter(function (movie) {
	    return String(movie.id) === currentMovieId;
	  });
	  var currentMovie = currentMovieArray[0];
	  ...
	  moviePostsApi.getMoviePosts().then(function (data) {
	    store.moviePosts = data.movie_posts;
	    store.currentMoviePosts = data.movie_posts.filter(function (moviePost) {
	      return moviePost.movie_id === currentMovie.id;
	    });
	    store.currentMoviePosts.forEach(function (moviePost) {
	      moviePost.isUserMoviePost = false;
	      if (store.user.id === moviePost.user_id) {
	        moviePost.isUserMoviePost = true;
	      }
	    });
	    var moviePageHTML = moviePageView({
	      movie: currentMovie,
	  ...
	  }).then(getMoviePostsSuccess).catch(getMoviePostsFailure);
	};
	...
	module.exports = {
	  ...
	  getUserMoviesSuccess: getUserMoviesSuccess,
	  getUserMoviesFailure: getUserMoviesFailure,
	  renderMoviePage: renderMoviePage
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"card col-xs-3\" style=\"padding: 20px; height: 200px;\">\n    <img class=\"card-img-top img-thumbnail\" src=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.img_url : stack1), depth0))
	    + "\" alt=\"Movie Poster\" style=\"padding: 15px\">\n    <div class=\"card-block\" style=\"padding: 10px\">\n      <h4 class=\"card-title movie-card-title\">"
	    ...
	    + "</p>\n      <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-primary view-movie-page-button\">View Movie</button>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"col-xs-12\">\n  <h2>Movies</h2><button class=\"btn btn-success view-create-movie-fields-button\">Create New Movie</button>\n</div>\n<div class=\"container all-movies-page signed-in-view\">\n\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <div class=\"movie-management-buttons\" style=\"margin-top: 15px;\">\n        <button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-warning edit-movie-button\">Edit Movie</button>\n        <button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-danger delete-movie-button\">Delete Movie</button>\n      </div>\n";
	},"3":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "      <div class=\"col-xs-12\">\n        <div class=\"panel panel-info\">\n          <div class=\"panel-heading\"><b>Author ID:</b> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.user_id : stack1), depth0))
	    + "|   <b>Comment Id:</b> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "|   <b>Parent Comment Id:</b> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.parent_movie_post_id : stack1), depth0))
	    + "|</div>\n          <div class=\"panel-body\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.comment : stack1), depth0))
	    + "</div>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.isUserMoviePost : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "        </div>\n      </div>\n";
	},"4":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "            <div class=\"panel-footer\" style=\"text-align: right;\">\n              <!-- <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-sm btn-warning edit-comment-button\">Edit</button> -->\n              <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-sm btn-danger delete-comment-button\">Delete</button>\n            </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression, alias3=depth0 != null ? depth0 : (container.nullContext || {});

	  return "<div id=\"movie-page-view\" class=\"row movie-page-view\">\n\n<div class=\"col-xs-8 offset-xs-2 centered\">\n  <div class=\"row movie-poster-div\">\n    <div class=\"center-block\">\n      <img class=\"movie-page-main-image\" src=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.img_url : stack1), depth0))
	    + "\" alt=\"Movie Poster\" style=\"padding: 15px; max-width: 100%;\">\n    </div>\n  </div>\n  <br>\n  <div class=\"movie-content center-block\">\n    <h2>Movie Info</h2>\n    <h4>Title: <a href=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.title_imdb_url : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</a></h4>\n    <h4>Director: <a href=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.director_imdb_url : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.director : stack1), depth0))
	    + "</a></h4>\n    <h4>Writer: <a href=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.writer_imdb_url : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.writer : stack1), depth0))
	    + "</a></h4>\n    <h4>Cinematographer: <a href=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.cinematographer_imdb_url : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.cinematographer : stack1), depth0))
	    + "</a></h4>\n    <h4>Music: <a href=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.music_imdb_url : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.music : stack1), depth0))
	    + "</a></h4>\n    <h4>Rotten Tomatoes: <a href=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.title_rotten_url : stack1), depth0))
	    + "\">Reviews</a></h4>\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.isUserMovie : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </div>\n\n  <br>\n\n  <div class=\"container enter-comment-on-movie\" style=\"margin-top: 40px;\">\n  <h3>Comment directly on "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.movie : depth0)) != null ? stack1.title : stack1), depth0))
	    + " or respond to someone in the comment section</h3>\n\n  <form id=\"submit-comment-on-movie\" class=\"submit-comment-on-movie col-xs-8\">\n    <div class=\"form-group\">\n\n      <div class=\"form-group\" hidden>\n        <input id=\"movie-id-input\" type=\"number\" name=\"movie_post[movie_id]\" class=\"form-control new-movie-post-input\">\n      </div>\n      <br>\n      <div class=\"form-group\" hidden>\n        <input id=\"user-id-input\" type=\"number\" name=\"movie_post[user_id]\" class=\"form-control new-movie-post-input\">\n      </div>\n      <br>\n      <div class=\"form-group\">\n        <!-- <label for=\"parent\">Parent Movie Post Id (optional)</label> -->\n        <input id=\"parent-movie-post-id-input\" type=\"number\" name=\"movie_post[parent_movie_post_id]\" class=\"form-control col-xs-3 new-movie-post-input\" placeholder=\"Parent movie id optional\">\n      </div>\n      <br><br>\n      <textarea class=\"form-control\" name=\"movie_post[comment]\" rows=\"5\" id=\"comment\" placeholder=\"Comment\"></textarea>\n    </div>\n    <div>\n    <button type=\"submit\" class=\"btn btn-success\">Submit</button>\n  </div>\n  </form>\n\n  </div>\n  <br>\n\n  <div class=\"comment-section\" style=\"margin-top: 50px;\">\n    <h3>All Comments</h3>\n    <br>\n"
	    + ((stack1 = helpers.each.call(alias3,(depth0 != null ? depth0.comments : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n  </div>\n</div>\n</div>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id=\"create-movie-fields\" class=\"signed-in-view col-xs-8\">\n      <div class=\"create-movie-header\">\n        <h2>Create New Movie</h2>\n      </div>\n      <div class=\"create-movie-forms-body\">\n      <form id=\"movie_params\" class=\"form-inline movie_params signed-in-view\">\n\n        <div class=\"form-group\">\n          <label for=\"movie-title\">Movie Title*</label>\n          <input id=\"movie-title-input\" type=\"text\" name=\"movie[title]\" class=\"form-control\" autofocus required>\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"director\">IMDB URL for Movie*</label>\n          <input id=\"movie-title-imdb-url-input\" type=\"text\" name=\"movie[title_imdb_url]\" class=\"form-control\" required>\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"director\">Rotten Tomatoes Link for Movie</label>\n          <input id=\"movie-title-rotten-url-input\" type=\"text\" name=\"movie[title_rotten_url]\" class=\"form-control\">\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"comment\">Director*</label>\n          <input id=\"movie-director-input\" type=\"text\" name=\"movie[director]\" class=\"form-control\" required>\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"comment\">IMDB URL for Director</label>\n          <input id=\"movie-director-imdb-url-input\" type=\"text\" name=\"movie[director_imdb_url]\" class=\"form-control\">\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"comment\">Writer*</label>\n          <input id=\"movie-writer-input\" type=\"text\" name=\"movie[writer]\" class=\"form-control\" required>\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"comment\">IMDB URL for Writer</label>\n          <input id=\"movie-writer-imdb-url-input\" type=\"text\" name=\"movie[writer_imdb_url]\" class=\"form-control\">\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"comment\">Cinematographer*</label>\n          <input id=\"movie-cinematographer-input\" type=\"text\" name=\"movie[cinematographer]\" class=\"form-control\" required>\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"comment\">IMDB URL for Cinematographer</label>\n          <input id=\"movie-cinematographer-imdb-url-input\" type=\"text\" name=\"movie[cinematographer_imdb_url]\" class=\"form-control\">\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"comment\">Score Composer*</label>\n          <input id=\"movie-composer-input\" type=\"text\" name=\"movie[music]\" class=\"form-control\" required>\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"comment\">IMDB URL for Score Composer</label>\n          <input id=\"movie-composer-imdb-url-input\" type=\"text\" name=\"movie[music_imdb_url]\" class=\"form-control\">\n        </div>\n        <br>\n        <div class=\"form-group\">\n          <label for=\"comment\">Image URL for Movie*</label>\n          <input id=\"movie-image-url-input\" type=\"text\" name=\"movie[img_url]\" class=\"form-control\" required>\n        </div>\n\n        <br>\n        <div class=\"form-group\">\n          <button type=\"submit\" class=\"btn btn-success submit-create-new-movie-button\">Create</button>\n          <button type=\"submit\" class=\"btn btn-warning cancel-create-new-movie-button\">Cancel</button>\n        </div>\n      </form>\n\n    </div>\n\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id=\"edit-movie-fields\" class=\"signed-in-view col-xs-8\">\n  <div class=\"edit-movie-header\">\n    <h2>Edit Movie</h2>\n  </div>\n  <div class=\"edit-movie-forms-body\">\n  <form id=\"edit-movie_params\" class=\"form-inline signed-in-view\">\n\n    <div class=\"form-group hide-movie-id\">\n      <label for=\"movie-id\">Movie Id</label>\n      <input id=\"edit-movie-id-input\" type=\"number\" name=\"movie[id]\" class=\"form-control\">\n    </div>\n    <br>\n    <div class=\"form-group\">\n      <label for=\"movie-title\">Movie Title*</label>\n      <input id=\"edit-movie-title-input\" type=\"text\" name=\"movie[title]\" class=\"form-control\" autofocus required>\n    </div>\n    <br>\n    <div class=\"form-group\">\n      <label for=\"director\">IMDB URL for Movie*</label>\n      <input id=\"edit-movie-title-imdb-url-input\" type=\"text\" name=\"movie[title_imdb_url]\" class=\"form-control\" required>\n    </div>\n    <br>\n    <div class=\"form-group\">\n      <label for=\"director\">Rotten Tomatoes Link for Movie</label>\n      <input id=\"edit-movie-title-rotten-url-input\" type=\"text\" name=\"movie[title_rotten_url]\" class=\"form-control\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"comment\">Director*</label>\n      <input id=\"edit-movie-director-input\" type=\"text\" name=\"movie[director]\" class=\"form-control\" required>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"comment\">IMDB URL for Director</label>\n      <input id=\"edit-movie-director-imdb-url-input\" type=\"text\" name=\"movie[director_imdb_url]\" class=\"form-control\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"comment\">Writer*</label>\n      <input id=\"edit-movie-writer-input\" type=\"text\" name=\"movie[writer]\" class=\"form-control\" required>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"comment\">IMDB URL for Writer</label>\n      <input id=\"edit-movie-writer-imdb-url-input\" type=\"text\" name=\"movie[writer_imdb_url]\" class=\"form-control\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"comment\">Cinematographer*</label>\n      <input id=\"edit-movie-cinematographer-input\" type=\"text\" name=\"movie[cinematographer]\" class=\"form-control\" required>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"comment\">IMDB URL for Cinematographer</label>\n      <input id=\"edit-movie-cinematographer-imdb-url-input\" type=\"text\" name=\"movie[cinematographer_imdb_url]\" class=\"form-control\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"comment\">Score Composer*</label>\n      <input id=\"edit-movie-composer-input\" type=\"text\" name=\"movie[music]\" class=\"form-control\" required>\n    </div>\n    <div class=\"form-group\">\n      <label for=\"comment\">IMDB URL for Score Composer</label>\n      <input id=\"edit-movie-composer-imdb-url-input\" type=\"text\" name=\"movie[music_imdb_url]\" class=\"form-control\">\n    </div>\n    <div class=\"form-group\">\n      <label for=\"comment\">Image URL for Movie*</label>\n      <input id=\"edit-movie-image-url-input\" type=\"text\" name=\"movie[img_url]\" class=\"form-control\" required>\n    </div>\n    <br>\n    <div class=\"form-group\">\n      <button type=\"submit\" class=\"btn btn-success\">Confirm Changes</button>\n      <button class=\"btn btn-warning cancel-edit-movie-button\">Cancel</button>\n    </div>\n\n  </form>\n  </div>\n\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetUserMovies = function onGetUserMovies(event) {
	  event.preventDefault();
	  // Eventually mayybe change this to only GET user movies from back end
	  api.getMovies().then(ui.getUserMoviesSuccess).catch(ui.getUserMoviesFailure);
	};
